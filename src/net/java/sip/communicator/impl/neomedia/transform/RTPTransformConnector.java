    ...
    extends RTPConnectorImpl
{
    ...
    protected TransformOutputStream createControlOutputStream()
        throws IOException
    {
        TransformOutputStream controlOutputStream
            = new TransformOutputStream(getControlSocket());
        ...
        throws IOException
    {
        TransformInputStream dataInputStream
            = new TransformInputStream(getDataSocket());
        ...
        throws IOException
    {
        TransformOutputStream dataOutputStream
            = new TransformOutputStream(getDataSocket());
    ...
    public void setEngine(TransformEngine engine)
    {
        if (this.engine != engine)
        {
            ...
            {
                controlInputStream
                    = (TransformInputStream) getControlInputStream(false);
            }
            ...
            {
                controlOutputStream
                    = (TransformOutputStream) getControlOutputStream(false);
            }
            catch (IOException ioex)
            {
                logger.error("The impossible happened", ioex);
            ...
            {
                dataInputStream
                    = (TransformInputStream) getDataInputStream(false);
            }
            catch (IOException ioex)
            {
                logger.error("The impossible happened", ioex);
            ...
            {
                dataOutputStream
                    = (TransformOutputStream) getDataOutputStream(false);
            }
            catch (IOException ioex)
            {
                logger.error("The impossible happened", ioex);
