...
/**
 * The ICQ implementation of the <tt>ChatRoomInvitation</tt> interface.
 * @author Rupert Burchardi
 */
public class ChatRoomInvitationIcqImpl implements ChatRoomInvitation
{
   /**
   ...
   /**
    * Creates an instance of the <tt>ChatRoomInvitationIcqImpl</tt> by
    ...
    */
   public ChatRoomInvitationIcqImpl(ChatRoom targetChatRoom, String inviter,
