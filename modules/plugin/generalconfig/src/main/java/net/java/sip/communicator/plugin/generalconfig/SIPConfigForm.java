    ...
    implements ActionListener
{
    ...
    public SIPConfigForm()
    {
        ...
        clientSecurePortField.setText(
            String.valueOf(getClientSecurePort()));
    ...
    {
        return GeneralConfigPluginActivator.getConfigurationService().getInt(
