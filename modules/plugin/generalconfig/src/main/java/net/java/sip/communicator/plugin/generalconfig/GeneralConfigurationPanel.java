    ...
    extends TransparentPanel
{
    ...
    public Component createMinimzeInsteadOfHideCheckBox()
    {
        ...
        chk.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                ...
                GeneralConfigPluginActivator.getUIService().setMainWindowCanHide(
                    GeneralConfigPluginActivator.getSystrayService().checkInitialized());
            }
        });
    ...
    private Component createRecentMessagesCheckbox()
    {
        ...
        recentMessagesCheckBox.setSelected(
            historyService.isRecentMessagesShown());

        recentMessagesCheckBox.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                historyService.setRecentMessagesShown(
    ...
    private Component createLocaleConfigPanel()
    {
        ...
        Locale currentLocale = getCurrentLanguage();
    ...
    {
        String localeId
            = GeneralConfigPluginActivator.getConfigurationService().getString(
            ResourceManagementService.DEFAULT_LOCALE_CONFIG);

        return
            (localeId != null)
                ? LocaleUtil.getLocale(localeId)
                : Locale.getDefault();
    }
    ...
    public static void setLanguage(Locale locale)
    {
        ...
        GeneralConfigPluginActivator.getConfigurationService().setProperty(
            ResourceManagementService.DEFAULT_LOCALE_CONFIG,
