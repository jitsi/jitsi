 ...
 */
public class SwingExtendedTooltip
    extends JToolTip
               ...
               ExtendedTooltip
{
     ...
     */
    public SwingExtendedTooltip(boolean isListViewEnabled)
    {
    ...
    public static class ImageToolTipUI extends MetalToolTipUI
    {
        ...
        public void update(Graphics g, JComponent c)
        {
            JTextArea bottomTextArea =
                ((SwingExtendedTooltip)c).bottomTextArea;
        ...
        {
            SwingExtendedTooltip tooltip = (SwingExtendedTooltip)c;
