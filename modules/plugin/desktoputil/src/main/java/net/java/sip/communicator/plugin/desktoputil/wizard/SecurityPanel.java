        ...
        TableModelListener
{
    ...
    private static class SavpOption
    {
        ...
        {
            return DesktopUtilActivator.getResources().getI18NString(
    ...
    private void initComponents()
    {
        ...
        enableDefaultEncryption = new SIPCommCheckBox(DesktopUtilActivator
            .getResources()
        ...
        lblWarning.setText(DesktopUtilActivator.getResources().getI18NString(
        ...
        cmdExpandAdvancedSettings.setIcon(DesktopUtilActivator.getResources()
            .getImage("service.gui.icons.RIGHT_ARROW_ICON"));
        cmdExpandAdvancedSettings.setText(DesktopUtilActivator.getResources()
        ...
        lblEncryptionProtocolPreferences.setText(DesktopUtilActivator.getResources()
            .getI18NString(
        ...
        lblZrtpOption.setText(DesktopUtilActivator.getResources()
        ...
        lblSDesOption.setText(DesktopUtilActivator.getResources().getI18NString(
        ...
        lblCipherInfo.setText(DesktopUtilActivator.getResources()
        ...
        lblSavpOption.setText(DesktopUtilActivator.getResources().getI18NString(
     ...
     * priority.
     *
     * @param encryptionProtocols The list of enabled encryption protocol
     * available for this account.
     * @param encryptionProtocolStatus The list of disabled encryption protocol
     * available for this account.
     */
