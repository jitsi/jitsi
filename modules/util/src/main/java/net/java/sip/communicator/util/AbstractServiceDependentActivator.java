    ...
    implements BundleActivator
{
     ...
     */
    private T dependentService = null;
     ...
     */
    public abstract void start(T dependentService) throws Exception;

    /**
     * The class of the service which this activator is interested in.
     * @return the class name.
     */
    public abstract Class<T> getDependentServiceClass();
     ...
     */
    private T getDependentService(BundleContext context)
    {
        if(dependentService == null)
        {
            ServiceReference<T> serviceRef
        ...
        implements ServiceListener
    {
        ...
        {
            T depService = getDependentService(context);
            if (depService != null)
            {
                ...
                {
                    logger.error("Could not start dependent service", e);
                }
            }
        }
    }
