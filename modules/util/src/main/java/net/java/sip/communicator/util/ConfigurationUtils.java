...
public class ConfigurationUtils
{
    ...
    public static void loadGuiConfigurations()
    {
        ...
        if(autoPopup == null)
            autoPopup = configService.
                getString(autoPopupProperty);
        ...
        sendMessageCommand = configService
            .getString(messageCommandProperty);
        ...
        if(isSendTypingNotif == null)
            isSendTypingNotif =
                configService.
                    getString(isSendTypingNotifProperty);
        ...
        if(isMultiChatWindowEnabledString == null)
            isMultiChatWindowEnabledString =
                configService.
                    getString(isMultiChatWindowEnabledStringProperty);
        ...
        if(isHistoryShownString == null)
            isHistoryShownString =
                configService.
                    getString(isHistoryShownStringProperty);
        ...
        if(chatHistorySizeString == null)
            chatHistorySizeString =
                configService.
                    getString(chatHistorySizeStringProperty);
        ...
        if(chatWriteAreaSizeString == null)
            chatWriteAreaSizeString =
                configService.
                    getString(chatWriteAreaSizeStringProperty);
        ...
        if(isTransparentWindowEnabledString == null)
            isTransparentWindowEnabledString =
                configService.
                    getString(isTransparentWindowEnabledProperty);
        ...
        if(windowTransparencyString == null)
            windowTransparencyString =
                configService.
                    getString(windowTransparencyProperty);
        ...
        if(isWindowDecoratedString == null)
            isWindowDecoratedString =
                configService.
                    getString(isWindowDecoratedProperty);
        ...
        String showStatusChangedInChatDefault = configService.
            getString(showStatusChangedInChatProperty);
        ...
        String routeVideoAndDesktopUsingPhoneNumberDefault =
            configService
                .getString(routeVideoAndDesktopUsingPhoneNumberProperty);
        ...
        String hideAccountMenuDefaultValue = configService
            .getString(hideAccountMenuProperty);
        ...
        String hideAccountsStatusDefaultValue = configService
            .getString(hideAccountStatusSelectorsProperty);
        ...
        String autoAnswerDisableSubmenuDefaultValue =
            configService
                .getString(autoAnswerDisableSubmenuProperty);
        ...
        String hideExtendedAwayStatusDefaultValue = configService
            .getString(hideExtendedAwayStatusProperty);
    ...
    public static boolean isFontSupportEnabled()
    {
        ...
        String defaultSettingStr =
            configService.getString(fontDisabledProp);
     ...
     *
     * @param accountUniqueId the protocol provider to which the chat room
     * belongs
     ...
     */
    public static void saveChatRoom(  String accountUniqueId,
    ...
    public static boolean isShowAccountConfig()
    {
        ...
        boolean defaultValue
            = !Boolean.parseBoolean(configService
                .getString(
