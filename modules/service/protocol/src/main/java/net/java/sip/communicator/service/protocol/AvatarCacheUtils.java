...
public class AvatarCacheUtils
{
     ...
     * corresponding to the given protocol provider.
     *
     * @param protocolContact the contact for which the cached should
     *                       be obtained
     * @return the bytes of the avatar image stored for the account
     * corresponding to the given protocol provider
     */
     ...
     * corresponding to the given protocol provider.
     *
     * @param protocolContact the contact whose avatar path is to be obtained
     * @return the bytes of the avatar image stored for the account
     * corresponding to the given protocol provider
     */
                                    ...
                                    byte[] avatarBytes)
    {
        ...
        try
        {
            FileAccessService fileAccessService
                = ProtocolProviderActivator.getFileAccessService();
