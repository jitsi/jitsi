                ...
                ServiceListener
{
     ...
     */
    @Override
    public void formatDate(Date date, StringBuffer dateStrBuf)
    {
        Calendar c1 = Calendar.getInstance();
        c1.setTime(date);

        dateStrBuf.append(processMonth(c1.get(Calendar.MONTH)));
        dateStrBuf.append(' ');
    ...
    private static String processMonth(int month)
    {
        ...
        return CallHistoryActivator.getResources().getI18NString(monthStringKey);
    }
