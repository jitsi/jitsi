                ...
                LocalUserAdHocChatRoomPresenceListener
{
    ...
    public void start(BundleContext bc)
    {
        ...
        isHistoryLoggingEnabled = configService.getBoolean(
            MessageHistoryService.PNAME_IS_MESSAGE_HISTORY_ENABLED,
            Boolean.parseBoolean(MessageHistoryActivator
    ...
    {
        if(isShown && isHistoryLoggingEnabled)
        {
            loadRecentMessages();
        }
        else
    ...
    public boolean isRecentMessagesShown()
    {
        return !configService.getBoolean(
            MessageHistoryService.PNAME_IS_RECENT_MESSAGES_DISABLED, true);
    }
}
