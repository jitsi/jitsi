               ...
               ContactCapabilitiesListener
{
     ...
     */
    public MetaContactListServiceImpl(ResourceManagementService res)
    {
        rootMetaGroup
            = new MetaContactGroupImpl(
                    this, res.getI18NString(
    ...
    public void serviceChanged(ServiceEvent event)
    {
        ...
        else if (event.getType() == ServiceEvent.UNREGISTERING)
        {
            ...
            AccountManager am = ContactlistActivator.getAccountManager();
            if(am != null && am.getStoredAccounts().contains(accountID))
            {
